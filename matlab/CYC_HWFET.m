...
%
% Notes:
% This data represents the Highway Fuel Economy Test (HFET) driving cycle used by the
% US EPA for Corporate Average Fuel Economy (CAFE) certification of passenger
% vehicles in the US.
% 
...
% 8/14/00 AB:  Added HFET to description
